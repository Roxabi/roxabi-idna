...
- [docs/operations.md](docs/operations.md) — ops runbook (systemd, logs, data dirs)
...
```bash
make idna start      # systemd user unit (make install-service once)
make idna logs       # journalctl follow
